window.vizitlink3dTema = {
    ...
    modUygula: function(mod) {
        ...
        if (mod === "koyu") {
            ...
            r.style.setProperty("--tema-arkaplan","#131313");
            r.style.setProperty("--tema-arkaplan-2","#1a1a1a");
            r.style.setProperty("--tema-yuzey","#1e2020");
...
document.addEventListener("DOMContentLoaded", function() {
    localStorage.setItem("temaMod", "acik");
    window.vizitlink3dTema.modUygula("acik");
    window.vizitlink3dTema.siteUygula("orpay-gunduz");
});
document.addEventListener('DOMContentLoaded', function() {
