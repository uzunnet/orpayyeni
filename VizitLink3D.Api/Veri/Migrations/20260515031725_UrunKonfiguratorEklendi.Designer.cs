...
namespace VizitLink3D.Api.Veri.Migrations
{
    ...
    [Migration("20260515031725_UrunKonfiguratorEklendi")]
    partial class UrunKonfiguratorEklendi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.BlogResim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.BlogYazisi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.KaplamaSecenegi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.Malzeme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.RalRengi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.RenkKatalogu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.Urun", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Ad = "Luna Duþakabin",
                            AktifMi = true,
                            KisaAciklama = "Çerçevesiz temperli cam, krom profil",
                            Kod = "DSK-001",
                        ...
                        {
                            Id = 2,
                            Ad = "Aria Banyo Dolabý",
                            AktifMi = true,
                            KisaAciklama = "LED aydýnlatmalý, yumuþak kapanýr kapak",
                            Kod = "BD-001",
                            OlusturulmaTarihi = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            OneCikanMi = true,
                            SilindiMi = false,
                            SiraNo = 1,
                            Slug = "banyo-dolabi-aria",
                            UrunAilesiId = 2,
                            YeniMi = true
                        },
                        new
                        {
                            ...
                            Ad = "Imperial Kapý",
                            AktifMi = true,
                            KisaAciklama = "Masif ahþap görünümlü, bronz kulp",
                            Kod = "KPI-001",
                            OlusturulmaTarihi = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            OneCikanMi = true,
                            SilindiMi = false,
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.UrunAilesi", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Aciklama = "Modern duþakabin sistemleri",
                            Ad = "Duþakabin",
                            AktifMi = true,
                            OlusturulmaTarihi = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            SilindiMi = false,
                            SiraNo = 1,
                            Slug = "dusakabin",
                            VarsayilanDetaySablonu = "DusakabinKonfigurator"
                        },
                        new
                        {
                            Id = 2,
                            Aciklama = "Banyo dolabý modelleri",
                            Ad = "Banyo Dolabý",
                            AktifMi = true,
                            OlusturulmaTarihi = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            SilindiMi = false,
                            SiraNo = 2,
                            Slug = "banyo-dolabi",
                            VarsayilanDetaySablonu = "BanyoKonfigurator"
                        },
                        new
                        {
                            Id = 3,
                            Aciklama = "Vestiyer sistemleri",
                            Ad = "Vestiyer",
                            AktifMi = true,
                            OlusturulmaTarihi = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            SilindiMi = false,
                            SiraNo = 3,
                            Slug = "vestiyer",
                            VarsayilanDetaySablonu = "Endustriyel3D"
                        },
                        new
                        {
                            Id = 4,
                            Aciklama = "Ýç ve dýþ kapý modelleri",
                            Ad = "Kapý",
                            AktifMi = true,
                            OlusturulmaTarihi = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            SilindiMi = false,
                            SiraNo = 4,
                            Slug = "kapi",
                            VarsayilanDetaySablonu = "KapiKonfigurator"
                        },
                        new
                        {
                            Id = 5,
                            Aciklama = "Mobilya kapak sistemleri",
                            Ad = "Dolap Kapaðý",
                            AktifMi = true,
                            OlusturulmaTarihi = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            SilindiMi = false,
                            SiraNo = 5,
                            Slug = "dolap-kapagi",
                            VarsayilanDetaySablonu = "KapakKonfigurator"
                        });
                });
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.BlogResim", b =>
                {
                    b.HasOne("VizitLink3D.Ortak.Modeller.BlogYazisi", "BlogYazisi")
                        .WithMany("Resimler")
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.KaplamaSecenegi", b =>
                {
                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.Malzeme", "Malzeme")
                        .WithMany()
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.RalRengi", b =>
                {
                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.RenkKatalogu", "Katalog")
                        .WithMany()
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.Urun", b =>
                {
                    ...
                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.UrunKategori", "UrunKategori")
                        .WithMany()
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.UrunKategori", b =>
                {
                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.UrunKategori", "UstKategori")
                        .WithMany()
                        .HasForeignKey("UstKategoriId");
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.UrunKonfigurasyonKurali", b =>
                {
                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.UrunUcBoyutParcasi", "Parca1")
                        .WithMany()
                        .HasForeignKey("Parca1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.UrunUcBoyutParcasi", "Parca2")
                        .WithMany()
                        .HasForeignKey("Parca2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.UrunParcaEslemesi", b =>
                {
                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.UrunParcaGrubu", "ParcaGrubu")
                        .WithMany()
                        .HasForeignKey("ParcaGrubuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.UrunParcaMalzemeSecenegi", b =>
                {
                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.KaplamaSecenegi", "KaplamaSecenegi")
                        .WithMany()
                        .HasForeignKey("KaplamaSecenegiId");
            ...
            modelBuilder.Entity("VizitLink3D.Ortak.Modeller.Urunler.UrunParcaRenkSecenegi", b =>
                {
                    b.HasOne("VizitLink3D.Ortak.Modeller.Urunler.RalRengi", "RalRengi")
                        .WithMany()
                        .HasForeignKey("RalRengiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
