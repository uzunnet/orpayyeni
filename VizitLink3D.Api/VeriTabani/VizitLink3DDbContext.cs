...
/// <summary>
/// LisansDogrulama icin her zaman vizitlink3d.db'ye bagli context.
/// KiraciServisi'e bakmaz, dogrudan ana VT'ye baglanir.
/// Not: Temel sinif DbContextOptions&lt;VizitLink3DDbContext&gt; beklediginden
/// DI kaydinda options acikca bu tip ile uretilir (Program.cs).
/// </summary>
public class AnaVizitLink3DDbContext(DbContextOptions<VizitLink3DDbContext> secenekler) : VizitLink3DDbContext(secenekler, null!)
{
    protected override void OnConfiguring(DbContextOptionsBuilder secenekler)
    {
        if (!secenekler.IsConfigured)
        {
            secenekler.UseSqlite("Data Source=vizitlink3d.db");
        }
    }
}
